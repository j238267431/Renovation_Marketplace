<div class="w-100">
    ...
    <ul class="cell_list cell-xs-1 cell-sm-2 cell-lg-3 cell-xl-2" id="top_users-freelancer">
        @for ($i = 1; $i <= 12; $i++) <li class="click_container-link set_href @if($i > 10) d-none d-lg-block d-xl-none @endif">
            <div class="pr_block">
                <div class="clearfix user_brief d-flex">
                    ...
                    <div class="brief">
                        ...
                        <span class="login">
                            ...
                            <span class="icon-checkmark text-success" data-toggle="tooltip" data-original-title="Личность подтверждена" title="">
                            </span>
                        </span>
                    </div>
                </div>
