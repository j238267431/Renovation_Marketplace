...
@section('content')
    ...
    ($category ? ' в категории ' . $category->name : ''),
                ...
                <div class="cols_table no_hover indent-b10">
                    <div class="row">
                        ...
                        <div class="col-sm-5 col-md-4 col-lg-3 m-auto">
                            <a class="btn btn-secondary btn-md btn-block need_login" data-toggle="modal"
                               data-target="#advanced_search">Расширенный поиск</a>
                        </div>
                    </div>
                </div>
                            ...
                            <div class="col-sm-12">
                                <div class="card-company-hor">
                                    ...
                                    <div>
                                        {{-- Название --}}
                                        <div class="title">
                                            <a class="text-bold show_visited"
                                               href="{{ route('companies.show', $company) }}">{{ $company->name }}</a>
                                        </div>
